...
const ThankYou = async ({ searchParams }: PageProps) => {
    ...
    return (
        <main className="relative lg:min-h-full">
            ...
            <div>
                <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-22">
                    <div className="lg:col-start-2">
                        ...
                        {order._isPaid ? (
                            ...
                            <p className="mt-2 text-base text-muted-foreground">
                                ...
                                currently processing it. So hang tight ans
